...
4. 모르는 단어 "conversation"을 클릭하여 Oxford Dictionary 정의와 발음을 확인합니다
5. "I'm in love with the shape of you" 구문을 드래그하여 관련 YouTube 영상에서 실제 사용 예시를 학습합니다
...
2. **문장 학습 기능**
   ...
   - **인수 조건**:
     ...
     - Then: 해당 표현과 관련된 YouTube 영상이 좌측 비디오 플레이어에 재생된다
...
### 🌐 온라인에서 바로 체험
**[👉 LyricLang 체험하기](https://lyriclang.vercel.app)**
